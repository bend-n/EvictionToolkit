// core items
let items = [Items.copper, Items.lead];
...
// TODO: Reset the labels on worldloadevent
...
function getItemText(
  ...
  let latestString =
    ...
    (latest > 0
      ? latest >= halfLatest
        ? getNormalizedColor(125, 100, latest, halfLatest, latestMax, true)
        : getNormalizedColor(0, 100, latest, latestMin, halfLatest, false)
      : "") +
    formatNumber(latest, true) +
    closer;
  ...
  let meanString =
    ...
    (mean === 0
      ? closer
      : mean > 0
      ? getNormalizedColor(125, 100, mean, 0, meanMax, true) + "+"
      : getNormalizedColor(0, 100, mean, meanMin, 0, false)) +
